...
def get_parser():
    ...
    parser.add_argument('--sheaf_normalised', '--sheaf_normalized',
                        dest='sheaf_normalised', type=str2bool, default=True)
    ...
    parser.add_argument('--model',  type=str,
                        choices=['gcn','gat','sage','gin','sheaf'], default='gcn')
    ...
    parser.add_argument('--synthetic_size', type=int, default=12)
