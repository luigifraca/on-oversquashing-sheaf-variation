...
# custom imports
from .config import DEFAULT_DROPOUT, DEFAULT_INPUT_DROPOUT, DEFAULT_LEFT_WEIGHTS, DEFAULT_RIGHT_WEIGHTS, DEFAULT_SHEAF_ACTIVATION
...
class SheafDiffusion(nn.Module):
    ...
    def update_edge_index(self, edge_index):
        validate_edge_index(edge_index, num_nodes=self.graph_size, require_unique_edges=True)
        self.edge_index = edge_index
